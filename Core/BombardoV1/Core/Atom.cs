...
namespace Bombardo.V1
{
    ...
    public class Atom
    {
        ...
        public (Atom, Atom, Atom, Atom) Split4()
        {
            Atom iter = this;
        ...
        public (Atom, Atom, Atom, Atom, Atom) Split5()
        {
            Atom iter = this;
        ...
        public (Atom, Atom, Atom, Atom, Atom, Atom) Split6()
        {
            Atom iter = this;
        ...
        public (Atom, Atom, Atom, Atom, Atom, Atom, Atom) Split7()
        {
            Atom iter = this;
