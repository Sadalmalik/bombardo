...
namespace Bombardo.V2
{
    ...
    {
        //  Ищет файл в текущей папке приложения и всех родителях
        //  Нужно в основном для тестов
        ...
        //  Механизм упорядоченного поиска для директив
        //      (preprocess ("somepath/something" "name"))
        //      (require "somepath/something")
        //  
