...
Начав экспериментировать с lisp я оценил возможность писать в именах все подряд символы. Но впоследствии почувствовал что визуально код буд-то замусоривается. Поскольку я работаю с самописным языком - у меня нет встроенной подсветки, так что нетекстовые символы ощутимо цепляют глаза.  
...
Никаких дефисов и иных спец-символов внутри имён. Если вам это кажется неудобным - вы можете для своих экспериментов переименовать имена всех реализованных частей языка в файле AllNames.cs
