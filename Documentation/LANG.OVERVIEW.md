...
Но пока руки до этого не дошли, опэтому я сделал класс, который исполняет s-выражения, проверяет их соответствие желаемым результатам и в конце выводит отчёт.  
