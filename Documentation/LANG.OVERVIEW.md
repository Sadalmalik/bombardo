...
Сопоставление с образцом - важная часть логического программирования (которое я так же реализовывал по учебнику SICP) и при необходимости отдельно опишу всю систему. Но уже как-нибудь потом.
...
Является альтернативой отложенных очередей.  
**In progress**
