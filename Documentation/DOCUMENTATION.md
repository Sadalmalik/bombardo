...
В отличае от контекстов таблицы не имеют родительских элементов (но это можно легко реализовать при необходимости).  
Кроме того в языке реализован специальный [синтаксический сахар](LANG.OVERVIEW.md#синтаксический-сахар-таблиц) для обращения к элементам таблиц.
